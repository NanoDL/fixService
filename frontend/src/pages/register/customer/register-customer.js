...
function submitForm() {
  ...
  const apiData = {
    ...
    preferredContactMethod: formDataObj.preferredContactMethod || 'phone',
    interestedServices: formDataObj.interestedServices || [],
    marketingAgree: !!formDataObj.marketingAgree
  };
